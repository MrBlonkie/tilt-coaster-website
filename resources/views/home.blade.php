        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div class="px-5 py-3.5 border-b border-gray-200 shrink-0">
                    <h2 class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Bediening</h2>
                </div>
                <div class="flex-1 flex flex-col justify-center p-4">
                <div class="grid grid-cols-2 gap-3">
                    <a href="/auto-control"
                        class="flex flex-col items-center gap-2.5 p-4 bg-[var(--color-ember)]/10 hover:bg-[var(--color-ember)]/20 border border-[var(--color-ember)]/25 rounded-xl transition-all text-center group">
                        ...
                        <div>
                            <div class="text-sm font-bold text-gray-900">Auto</div>
                            <div class="text-[11px] text-gray-500 leading-tight mt-0.5">Volledig automatisch</div>
                        </div>
                    </a>
                    <a href="/manual-control"
                        class="flex flex-col items-center gap-2.5 p-4 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl transition-all text-center group">
                        <div class="p-2.5 bg-gray-200 rounded-lg group-hover:scale-105 transition-transform">
                        ...
                        <div>
                            <div class="text-sm font-bold text-gray-900">Manueel</div>
                            <div class="text-[11px] text-gray-500 leading-tight mt-0.5">Handmatige besturing</div>
                        </div>
                    </a>
                </div>
                </div>
            ...
            <div class="lg:col-span-2 flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div class="px-5 py-3.5 border-b border-gray-200 flex items-center gap-3 shrink-0">
                    ...
                    <h2 class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Systeem Log</h2>
                    <span class="ml-auto text-xs font-mono text-gray-400" id="log-count">0 events</span>
                </div>
                <div class="flex-1 flex flex-col p-3 bg-gray-50 min-h-0">
                    <ul id="event-log-list" class="flex-1 space-y-px overflow-y-auto font-mono text-xs pr-1 min-h-[100px]">
                        <li class="py-1 px-2 text-gray-400">Wachten op verbinding...</li>
                    </ul>
                </div>
            </div>

            {{-- Rij 2: Systeem Status (col 1) + Demo video (col 2-3) — zelfde hoogte via grid stretch --}}
            ...
            <div class="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="p-4 flex flex-col flex-1 space-y-4 overflow-y-auto">
                    ...
                    {{-- MQTT verbinding --}}
                    <div class="space-y-1.5 pb-3 border-b border-gray-100 shrink-0">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-mono text-gray-400">Connected since</span>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <canvas id="station-monitor" height="48" class="w-full rounded bg-gray-900 border border-gray-200"></canvas>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <canvas id="tiltdrop-monitor" height="48" class="w-full rounded bg-gray-900 border border-gray-200"></canvas>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <canvas id="brakes-monitor" height="48" class="w-full rounded bg-gray-900 border border-gray-200"></canvas>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <canvas id="switchtrack-monitor" height="48" class="w-full rounded bg-gray-900 border border-gray-200"></canvas>
                        </div>
